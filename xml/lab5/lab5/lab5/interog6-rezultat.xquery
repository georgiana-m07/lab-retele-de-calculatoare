...
(:Interogare care afișează lista pacienților de sex masculin, cu vârsta sub 30 de ani, care provin din mediul rural și au ca ultimă vaccinare epidemiologică vaccinul Antipneumococic:)

<h:ul> {
for $x in doc("pacienti.xml")/medical:cabinet/medical:categorii/medical:pacient
where $x/medical:varsta < 30 and $x/medical:sex = "M" and $x/medical:mediu = "Rural" and $x/medical:epidemiologie = "Antipneumococic"
